...
namespace DomainEventsConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var appointmentSchedulingService = ObjectFactory.GetInstance<AppointmentSchedulingService>();

            Console.WriteLine("Scheduling an appointment.");
            appointmentSchedulingService.ScheduleAppointment("steve@test1.com", DateTime.Now);
